...
object GeneratePdf {
    ...
    fun generate(bmp: Bitmap, receipt: Receipt): String {
        ...
        val pageInfo: PdfDocument.PageInfo = PdfDocument.PageInfo.Builder(pageWith, 2010, 1).create()
        ...
        canvas.drawText( String.format("%.2f", receipt.priceP1 * receipt.quantityP1),1150f,950f,myPaint)
        canvas.drawText(  String.format("%.2f", receipt.priceP2 * receipt.quantityP2),1150f,1050f,myPaint)
        canvas.drawText(  String.format("%.2f", receipt.priceP2 * receipt.quantityP3),1150f,1150f,myPaint)
        ...
        canvas.drawText("Total : " + String.format("%.2f", receipt.priceP1 + receipt.priceP3 + receipt.priceP3),1150f,1280f, myPaint)
